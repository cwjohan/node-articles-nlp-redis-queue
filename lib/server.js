...
function start() {
  ...
  function createServer() {
    // The following line commented out because we can't have the web server scraping
    // if there is a worker running.
    // if (config.thrifty) instance.startScraping();  ### TBD: Review this. ###
